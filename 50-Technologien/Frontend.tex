...
AngularJS war im Entwurfsstadium nie für Mobile- oder Unternehmensanwendungen gedacht.
...
Um Verwirrungen zu vermeiden, wurde das bis dahin bekannte Angular in \textquote{AngularJS} umbenannt und die neue Version \textquote{Angular 2} genannt. Die Versionierung von Angular folgt seit Version 2 dem Semantic Versioning Prinzip, bei dem die Versionsnummer in \linebreak \textquote[\cite{preston-wernerSemanticVersioning}]{MAJOR.MINOR.PATCH} untergliedert wird. \cite{gaviganHistoryAngular2018} 
