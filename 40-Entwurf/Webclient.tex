...
Die Interaktion mit dem DOM oder auch Virtual DOM kann selber entwickelt werden. Jedoch ist hierbei zu raten, auf bereits bestehende Frameworks wie Angular (Entwickelt unter der Leitung vom Angular Team bei Google), React (Entwickelt unter der Leitung von Facebook) oder Vue (Evan You und Core Team) zurückzugreifen. 
...
Das Grundlayout ist wie in \autoref{fig:mockup-base} abgebildet in drei Bereiche, Header, Navigation und Content, eingeteilt. 
...
\begin{center}
	...
	\captionof{figure}{Ausgeklapptes Menu beim hovern(Mockup)}
